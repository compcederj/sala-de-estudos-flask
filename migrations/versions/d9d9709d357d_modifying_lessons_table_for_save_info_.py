...
def upgrade():
    ...
    op.alter_column("lessons", "title", existing_type=sa.VARCHAR(length=100), nullable=False)
...
def downgrade():
    ...
    op.alter_column("lessons", "title", existing_type=sa.VARCHAR(length=100), nullable=True)
